...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit"><span class="entypo-check"></span></button>'+
                                '<button type="button" class="btn btn-danger editable-cancel"><span class="entypo-cancel-circled"></span></button>';         
